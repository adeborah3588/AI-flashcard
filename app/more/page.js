...
export default function LearnMore() {
  return (
    <Box sx={{ backgroundColor: '#FF9913', minHeight: '100vh', py: 4 }}>
      <Container maxWidth="md">
        <Box sx={{ my: 4 }}>
          ...
          <Typography variant="h3" component="h1" sx={{ fontFamily: "impact" }} gutterBottom>
            Learn More About Flashcard Generation
          </Typography>

          <Typography variant="body1" sx={{ mb: 4 }}>
            Flashcards are a powerful tool for studying and retaining information. By using our flashcard generation feature, you can quickly create custom flashcards tailored to your study needs. Whether you are preparing for exams, learning a new language, or just trying to memorize key concepts, flashcards can help you review and reinforce information effectively.
          </Typography>

          <Card sx={{ mb: 4, border: '8px solid #CC5500' }}> {/* Border color added */}
            <CardContent>
              <Typography variant="h5" component="h2" sx={{ fontFamily: "impact" }} gutterBottom>
          ...
          <Typography variant="body1" sx={{ fontFamily: "impact" }}>
